...
class KekkaiUtilizeAssets: 
	...
	# 寮结界 
	I_GUILD_REALM = RuleImage(roi_front=(1064,619,67,61), roi_back=(1030,610,170,130), threshold=0.8, method="Template matching", file="./tasks/KekkaiUtilize/ku/ku_guild_realm.png")
	# 祈愿 
	...
	# Image Rule Assets
	# 右上角的放置好友寄养 
	I_UTILIZE_ADD = RuleImage(roi_front=(1146,53,74,67), roi_back=(1146,53,74,67), threshold=0.8, method="Template matching", file="./tasks/KekkaiUtilize/utilize/utilize_utilize_add.png")
	# 好友这组 
	...
	# Click Rule Assets
	# 放置面板确认框"确定"按钮 
	C_U_REALM_CONFIRM = RuleClick(roi_front=(703,524,67,36), roi_back=(703,524,67,36), name="u_realm_confirm")
	# description 
	...
	# 斗鱼或太古寄养数目 
	O_CARD_NUM = RuleOcr(roi=(700,330,330,110), area=(700,330,330,110), mode="Single", method="Default", keyword="", name="card_num")
