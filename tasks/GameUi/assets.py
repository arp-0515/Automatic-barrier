...
class GameUiAssets: 
	...
	# description 
	I_CHECK_GUILD = RuleImage(roi_front=(1071,629,49,46), roi_back=(1040,600,100,80), threshold=0.8, method="Template matching", file="./tasks/GameUi/page/page_check_guild.png")
	# description 
